...
class ProductController(http.Controller):
    ...
    def supplier_rfq_sent(self):
        ...
        for row_num, quotation in enumerate(quotations, 1):
            ...
            quotation_worksheet.write(row_num, 2, quotation.user_name)  
            quotation_worksheet.write(row_num, 3, quotation.email)
            quotation_worksheet.write(row_num, 4, quotation.phone)
            quotation_worksheet.write(row_num, 5, quotation.message)
            quotation_worksheet.write(row_num, 6, quotation.member_type)
            quotation_worksheet.write(row_num, 7, quotation.company_website)
            quotation_worksheet.write(row_num, 8, quotation.product_description)
            quotation_worksheet.write(row_num, 9, quotation.minimum_order_quantity)
            quotation_worksheet.write(row_num, 10, quotation.unit.name)
            ...
            quotation_worksheet.write(row_num, 14, quotation.shipping_terms)
            quotation_worksheet.write(row_num, 15, quotation.payment_terms)
            quotation_worksheet.write(row_num, 16, quotation.buyers_country.name)
            ...
            quotation_worksheet.write(row_num, 27, quotation.contact_person)
            quotation_worksheet.write(row_num, 28, quotation.designation)
            quotation_worksheet.write(row_num, 29, quotation.contact_person_phone)
            quotation_worksheet.write(row_num, 30, quotation.contact_person_email)
    ...
    def supplier_rfq_received(self):
        ...
        # Write data to worksheet
        for row_num, enquiry in enumerate(enquiries, 1):
            enquiry_worksheet.write(row_num, 1, enquiry.create_date.strftime('%d-%b-%Y'))
            enquiry_worksheet.write(row_num, 2, enquiry.product_id.partner_id.name)
            enquiry_worksheet.write(row_num, 3, enquiry.product_id.partner_id.user_name)
            enquiry_worksheet.write(row_num, 4, enquiry.product_id.partner_id.email)
            enquiry_worksheet.write(row_num, 5, enquiry.product_id.partner_id.phone)
            enquiry_worksheet.write(row_num, 6, enquiry.message)
            enquiry_worksheet.write(row_num, 7, enquiry.product_id.partner_id.member_type)
            enquiry_worksheet.write(row_num, 8, enquiry.product_id.partner_id.company_website)
            enquiry_worksheet.write(row_num, 9, enquiry.product_id.product_description)
            enquiry_worksheet.write(row_num, 10, enquiry.product_id.product_quantity)
            enquiry_worksheet.write(row_num, 11, enquiry.product_id.unit.name)
            enquiry_worksheet.write(row_num, 12, enquiry.target_price)
            enquiry_worksheet.write(row_num, 13, enquiry.currency.name)
            enquiry_worksheet.write(row_num, 14, enquiry.country.name)
            enquiry_worksheet.write(row_num, 15, enquiry.product_id.shipping_terms)
            enquiry_worksheet.write(row_num, 16, enquiry.product_id.payment_mode)
            enquiry_worksheet.write(row_num, 17, enquiry.product_id.buyers_country.name)
            enquiry_worksheet.write(row_num, 18, enquiry.product_id.partner_id.primary_business)
            enquiry_worksheet.write(row_num, 19, enquiry.product_id.partner_id.establishment_year)
            enquiry_worksheet.write(row_num, 20, enquiry.product_id.partner_id.annual_sales)
            enquiry_worksheet.write(row_num, 21, enquiry.product_id.partner_id.no_of_employees)
            enquiry_worksheet.write(row_num, 22, enquiry.partner_id.country_id.name)
            enquiry_worksheet.write(row_num, 23, enquiry.partner_id.state_id.name)
            enquiry_worksheet.write(row_num, 24, enquiry.partner_id.city)
            enquiry_worksheet.write(row_num, 25, enquiry.partner_id.zip)
            enquiry_worksheet.write(row_num, 26, enquiry.partner_id.country_id.phone_code)
            enquiry_worksheet.write(row_num, 27, enquiry.partner_id.area_code)
            enquiry_worksheet.write(row_num, 28, enquiry.user_name)
            enquiry_worksheet.write(row_num, 29, enquiry.partner_id.designation)
            enquiry_worksheet.write(row_num, 30, enquiry.partner_id.phone)
